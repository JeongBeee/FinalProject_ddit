              ...
              <div class="tab-pane fade show active" id="inspcection" role="tabpanel">
		      	<div style="display:flex; margin:10px;">
		            ...
		            <div>
			           ...
			           <button type="button" id="autoCompleteBtnI" class="btn btn-xs btn-dark" onclick="autoComplBtnI()">자동완성</button>
              ...
              <div class="tab-pane fade" id="treatment" role="tabpanel">
	      		<div style="display:flex; margin:10px;">
		            ...
		            <div>
			            ...
			            <button type="button" id="autoCompleteBtnT" class="btn btn-xs btn-dark" onclick="autoComplBtnT()">자동완성</button>
		            </div>
		        </div>
					...
					xhr.onreadystatechange = () => {
						if (xhr.readyState == 4 && xhr.status == 200) {
							...
							for (let i = 0; i < rslt.length; i++) {
								tblStr += `<button type="button" id="dateBtn" class="btn btn-outline-primary" style="width:115px;" onclick="showChart('\${rslt[i].detailRegDate}','\${rslt[i].treatNo}')">\${rslt[i].detailRegDate}</button><br>`;
							}
							tblStr += "</div>"
...
// 					console.log("입원상태", patHsptlzStatus);
				...
				//자동완성버튼
				function autoComplBtnI(){
					$("#inspcMemo").val("정면 후면 2장씩 촬영 부탁 드립니다.");
				}
				function autoComplBtnT(){
					$("#treMemo").val("환자 알러지 반응 확인 후 처치 바랍니다.");
				}
			</script>
		</body>
